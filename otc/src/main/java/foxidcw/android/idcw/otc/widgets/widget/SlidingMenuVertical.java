    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(moveY - downY) > Math.abs(moveX - downX) && Math.abs(moveY - downY)>5) {
                    //上面隐藏
                    if (!opened) {
...
//                LogUtil.e("dy","++++++++++++++++++++++++++++"+dy);
                ...
                break;
            case MotionEvent.ACTION_UP:
//                LogUtil.e("heigth_top", "+++++++++++++++++" + height_top);
...
//        LogUtil.e("y_now", ScreenUtils.getViewScreenLocation(view_bottom)[1] + "++++++++++++++++++++++");
//
//        LogUtil.e("y_closed", y_opened - height_top + "++++++++++++++++++++++");

        LogUtil.d("SlidingMenuVertical", "getY_now():" + getY_now());
        LogUtil.d("SlidingMenuVertical", "getY_opened():" + getY_opened());
        LogUtil.d("SlidingMenuVertical", "getY_opened() - getHeight_top():" + (getY_opened() - getHeight_top()));
