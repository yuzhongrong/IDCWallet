...
public class NewKeyBoard extends RelativeLayout {
    ...
    private void initKeyboardView() {
        View view = View.inflate(context, R.layout.basic_view_new_keyboard, this);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                if (getItemViewType(position) == 1) {
                    //数字键
                    convertView = LayoutInflater.from(context).inflate(R.layout.basic_item_new_grid_keyboard, parent, false);
                    ...
                    //删除键
                    convertView = LayoutInflater.from(context).inflate(R.layout.basic_item_grid_new_keyboard_delete, parent, false);
                }
            }
