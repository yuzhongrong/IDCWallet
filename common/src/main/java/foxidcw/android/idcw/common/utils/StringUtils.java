...
*/
    ...
    public static String formatChangeTwo(double value) {
...
//            formater.setGroupingSize(0);
    ...
    public static String formatDouSix(double value) {
        //Locale
    ...
    public static String formatStringFour(String value) {
        //Locale
        return String.format(Locale.ENGLISH, "%,.4f", (Math.floor(Double.valueOf(value) * 10000)) / 10000);
    }
    ...
    //秒数转xx天xx小时
    public static String getTimeLeft(long forbidExpireTimestamp, Context context){
        //        int day = (int)TimeUnit.SECONDS.toDays(forbidExpireTimestamp);
        //        long hours = TimeUnit.SECONDS.toHours(forbidExpireTimestamp) - TimeUnit.SECONDS.toHours(TimeUnit.SECONDS.toDays(forbidExpireTimestamp));
        //        long minute = TimeUnit.SECONDS.toMinutes(forbidExpireTimestamp) - TimeUnit.SECONDS.toMinutes(TimeUnit.SECONDS.toHours(forbidExpireTimestamp));

        int day = (int) TimeUnit.SECONDS.toDays(forbidExpireTimestamp);
        long hours = TimeUnit.SECONDS.toHours(forbidExpireTimestamp - TimeUnit.DAYS.toSeconds(day));
        long minute = TimeUnit.SECONDS.toMinutes(forbidExpireTimestamp - TimeUnit.DAYS.toSeconds(day) - TimeUnit.HOURS.toSeconds(hours));
        ...
        //        LogUtil.e("Day" + day +" Hour" + hours +" Minute" + minute);
        if(day == 0){
//            int i1 = content.indexOf("%1");
//            int i2 = content.indexOf("%2") ; //不包括%号
//            String newContent = content.substring(0 , i1) + content.substring(i2);
//            String currentContent = newContent.replace('2', '1');
            return String.format(context.getString(R.string.str_otc_no_trading_prompt_hour), hours);
        }else if(hours == 0){
            return String.format(context.getString(R.string.str_otc_no_trading_prompt_day), day);
        }else {
            return String.format(context.getString(R.string.str_otc_no_trading_prompt), day, hours);
        }
    }
