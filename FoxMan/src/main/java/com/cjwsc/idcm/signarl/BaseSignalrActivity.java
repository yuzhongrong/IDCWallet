...
public abstract class BaseSignalrActivity<M extends BaseModel, P extends BasePresenter> extends BaseActivity<M, P> {
     ...
     * @param hub
     */
    protected synchronized void initSignalr(String mhost, String groupi, String hub) {
        synchronized (this) {
            if (!TextUtils.isEmpty(mhost)) {
                ...
                if (hubConnection == null) {
                    ...
                    if (hubConnection != null) {
                        ...
                        if (hubConnection != null) {
                            hubConnection.start();
                            SignalrConnectionManager.getInstance().addConnection(hubConnection);
                        }
    ...
    private void destorySignalr() {
        finishAllSubScribe();
        SignalrConnectionManager.getInstance().finishConnection(hubConnection);
        hubConnection=null;
        hubProxy = null;
    }
