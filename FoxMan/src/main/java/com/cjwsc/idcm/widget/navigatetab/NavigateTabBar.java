package com.cjwsc.idcm.widget.navigatetab;
...
import com.cjwsc.idcm.Utils.ThemeUtils;
...
public class NavigateTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public NavigateTabBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalTextColor = (tabTextColor != null ? tabTextColor : context.getResources().getColorStateList(R.color.c_a0a0ab));
...
//            showFragment(holder);
    ...
    public Fragment getCurrentShowFragment(){
        ...
        return getFragmentInstance(mCurrentTag);

    }

    public ViewHolder getViewHolderList(int index){
