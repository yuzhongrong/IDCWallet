...
/**
 * Created by hpz on 2018/4/24.
 */

public class NotSupportPopWindow extends BasePopupWindow {

    private TextView mIvClose;
    private TextView mTvContent;

    public NotSupportPopWindow(Context context) {
        super(context);
    }
    ...
    public View onCreatePopupView() {
        View root = createPopupById(R.layout.pop_not_support_window);
