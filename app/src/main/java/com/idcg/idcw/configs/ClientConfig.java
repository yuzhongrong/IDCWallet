package com.idcg.idcw.configs;

import com.idcg.idcw.utils.SharedPreUtils;
...
public class ClientConfig {
    ...
    public int getPosFind() {
        this.posFind = mSharedPre.getInt("posFind");
        return posFind;
    }

    public void setPosFind(int posFind) {
        this.posFind = posFind;
        mSharedPre.putInt("posFind",posFind);
    }
    ...
    public void setUserID(String userID) {
        this.userID = userID;
        this.savePayPass = mSharedPre.getString(userID + "savePayPass");
    }
